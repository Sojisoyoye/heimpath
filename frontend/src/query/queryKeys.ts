...
export const queryKeys = {
  ...
  portfolio: {
    ...
    properties: () => [...queryKeys.portfolio.all, "properties"] as const,
    ...
    taxSummary: (propertyId: string, year: number) =>
      [...queryKeys.portfolio.all, "taxSummary", propertyId, year] as const,

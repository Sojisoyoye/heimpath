...
- **AfA Depreciation Calculator (§ 7 EStG)** — Calculates German building depreciation (Abschreibung) for rental properties. Applies the correct AfA rate by construction era (2.5% pre-1925, 2.0% 1925–2022, 3.0% post-2022 per Jahressteuergesetz 2022), computes total Werbungskosten (AfA + mortgage interest + management + insurance + Grundsteuer + maintenance reserve), shows net taxable income, annual tax saving, and a 10-year cumulative tax saving bar chart. Includes location-type presets for land share. (#209)
- **Grundsteuer (Annual Property Tax) Calculator** — Estimates German annual property tax (Grundsteuer B) after the 2025 Grundsteuerreform across all three state models: Bundesmodell (14 states), Bavaria Flächenmodell (area-based), and Baden-Württemberg Bodenwertmodell (land value × Bodenrichtwert). Includes city Hebesatz presets for major cities in all 16 states, a bar chart comparing annual tax across the selected state's cities, and a quarterly/monthly payment breakdown. (#208)
